...
const Home = () => {
  const product = [
    {
      title: 'Grocery',
      image: require('../../../assests/images/one.png'),
    },
    {
      title: 'Vegetables',
      image: require('../../../assests/images/two.png'),
    },
    {
      title: 'Fruits',
      image: require('../../../assests/images/four.png'),
    },
    {
      title: 'Masala',
      image: require('../../../assests/images/three.png'),
    },
  ];
  ...
  const seconditems = [
    {
      title: 'meat',
      price: 'Rs.800-per kg',
      image: require('../../../assests/images/meat.png'),
    ...
    },
    {
      title: 'fish',
      price: 'Rs.800-per kg',
      image: require('../../../assests/images/fish.png'),
      discription1: 'This is product description',
      discription2: 'This is abc product description',
    },
    {
      title: 'Beef Qeema',
      price: 'Rs.800-per kg',
      image: require('../../../assests/images/beef.png'),
      discription1: 'This is product description',
      discription2: 'This is abc product description',
    },
    {
    ...
    <ScrollView keyboardShouldPersistTaps="handled" scrollEnabled={true}>
      <SafeAreaView style={{flex: 1}}>
        <View style={{width: '90%', alignSelf: 'center'}}>
          ...
          <Image
            source={require('../../../assests/images/Grocery.png')}
